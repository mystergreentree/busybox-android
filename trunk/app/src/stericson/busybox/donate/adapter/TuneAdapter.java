	...
	public View getView(final int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			if (position == 0)
			{
		    	...
		    	info_holder.version.setOnItemSelectedListener(new Version());
			    ...
			    String space = activity.getFreeSpace().getText().toString();

				activity.setFreeSpace((FontableTextView) vi.findViewById(R.id.freespace));
				
				activity.getFreeSpace().setText(space);
				...
				info_holder.clean.setOnCheckedChangeListener(new OnCheckedChangeListener()
				{
					...
					{
						if (isChecked)
							activity.initiatePopupWindow("This feature will instruct the installer to make sure that applets are not duplicated. This will keep your system cleaner, save more space, and will ensure that other applications do not have problems using the applets provided by Busybox.", false, activity);
