...
public class InstallAppletJob extends AsyncJob<Result>
{
	...
	public InstallAppletJob(MainActivity activity, String applet, int position,
			AdapterView<?> adapter)
	{
	...
	protected void onProgressUpdate(Object... values)
	{
		...
		TextView header = (TextView) App.getInstance().getPopupView()
				.findViewById(R.id.header);
		header.setText(this.activity.getString(R.string.installing) + " "
				+ values[0]);
	}
